    ...
    with app.app_context():
        ...
        try:
            ...
            if default_permission:
                ...
                print(f"✓ 分配权限: {default_permission.position}")
            
            db.session.commit()
            
            print(f"✓ 员工账号审核通过: {test_staff.name}")
            print(f"  - 审核状态: {test_staff.approval_status}")
...
def test_permission_assignment(staff_id):
    ...
    with app.app_context():
        ...
        try:
            ...
            print(f"✓ 权限分配成功: {test_staff.name}")
...
def test_user_registration():
    ...
    with app.app_context():
        ...
        try:
            ...
            print(f"✓ 普通用户注册成功: {test_user.name}")
...
def test_login_restrictions():
    ...
    with app.app_context():
        ...
        try:
            ...
            if pending_staff:
                print(f"✓ 找到待审核员工: {pending_staff.name}")
            ...
            if approved_staff:
                print(f"✓ 找到已审核员工: {approved_staff.name}")
