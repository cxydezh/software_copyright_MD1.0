# 软著管理系统 - Windows Server 自动化部署脚本
# 执行前请确保以管理员身份运行PowerShell
...
Write-Host "软著管理系统 - Windows Server 部署脚本" -ForegroundColor Green
Write-Host "==========================================" -ForegroundColor Green
...
Write-Host "==========================================" -ForegroundColor Green
Write-Host "网站地址: http://localhost" -ForegroundColor Cyan
if ($DomainName) {
    Write-Host "域名访问: http://$DomainName" -ForegroundColor Cyan
}
Write-Host "管理地址: http://localhost/staff/login" -ForegroundColor Cyan
